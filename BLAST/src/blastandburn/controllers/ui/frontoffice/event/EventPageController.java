    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        comboBox.getSelectionModel().select("All");
            ...
            for (int i = 0; i < service.listNotification(UserSession.getUser_id()).size(); i++) {
                Image notification = new Image("file:///" + projectPath + "/src/blastandburn/resources/images/events/alert.png");
...
//                tray.showAndWait();
        ...
        for (int i = 0; i < catEvents.size(); i++) {
            ...
            loader.setLocation(getClass().getResource("/blastandburn/views/ui/frontoffice/event/EventCategoryItem.fxml"));
            try {
...
//        GridPane pane = null;
//        FXMLLoader loader = new FXMLLoader();
//        loader.setLocation(getClass().getResource("/blastandburn/views/ui/frontoffice/event/GridEvent.fxml"));
//        try {
//            pane = loader.load();
...
//    }
    ...
    private void addEventAction(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/blastandburn/views/ui/frontoffice/event/AddEventF.fxml"));
    ...
    private void showAllCategoriesAction(MouseEvent event) throws IOException {
        ...
        pageHolder.getChildren().add(FXMLLoader.load(getClass().getResource("/blastandburn/views/ui/frontoffice/event/AllEventCategories.fxml")));
