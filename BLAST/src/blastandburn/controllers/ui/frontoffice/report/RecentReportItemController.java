...
public class RecentReportItemController implements Initializable {
    ...
    private void details(MouseEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/blastandburn/views/ui/frontoffice/report/OpenReportDetailsPage.fxml"));
        Parent root = null;
        try {
            root = loader.load();
        } catch (IOException ex) {
            Logger.getLogger(RecentReportItemController.class.getName()).log(Level.SEVERE, null, ex);
        }
