...
public class SessionPageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (UserSession.getRole().equals("coach") || UserSession.getRole().equals("nutritionist")) {
    ...
    private void addSessionAction(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/blastandburn/views/ui/frontoffice/session/AddSessionF.fxml"));
    ...
    private void SearchButtn(MouseEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/blastandburn/views/ui/frontoffice/session/SearchPage.fxml"));
